...
function ProductDetails(props) {
    ...
    const isProductInCart = props.cart.map(item => {
    ...
    },[props.history,props.selectedProduct])
            ...
            <div className={classes.productDetails__container}>
                ...
                <div className={classes.productDetails__desc}>
                    ...
                    <div className={classes.productDetails__quantity}>
                        <h4 className={classes.productDetails__price}>Nrs {product?.originalPrice - product?.discount}</h4>
